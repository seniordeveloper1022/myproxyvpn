...
import com.browser.myproxyvpn.adblock.AdBlock;
...
public class LightningWebClient extends WebViewClient {
    ...
    private static final String USERNAME = "V1xjM3jfzaD";
    private static final String PASSWORD = "zTPra4zjD9mH";
...
//        AlertDialog.Builder builder = new AlertDialog.Builder(mActivity);
        handler.proceed(USERNAME.trim(), PASSWORD.trim());
