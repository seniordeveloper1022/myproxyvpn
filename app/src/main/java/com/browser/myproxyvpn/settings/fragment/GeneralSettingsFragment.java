 ...
 */
package com.browser.myproxyvpn.settings.fragment;
...
import com.browser.myproxyvpn.BuildConfig;
...
import static com.browser.myproxyvpn.preference.PreferenceManager.Suggestion;
...
public class GeneralSettingsFragment extends LightningPreferenceFragment implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    private void setMPVGProxy() {
        int proxyPort = mPreferenceManager.getMpvgProxyPort();
        mPreferenceManager.setMpvgProxyHost();
        mPreferenceManager.setMpvgProxyPort(proxyPort);
    }
