package com.browser.myproxyvpn.preference;
...
public class PreferenceManager {
    ...
    public String getMpvgProxyHost() {
        return mPrefs.getString(Name.PROXY_HOST, MPVGProxyHost);
    }

    public int getMpvgProxyPort() {
        return mPrefs.getInt(Name.PROXY_PORT, getInitialProxyPort());
    }

    public int getInitialProxyPort() {
        return mPrefs.getInt(Name.INITIAL_PROXY_PORT,5000);
    }
    ...
    public int getUseTheme() {
        return mPrefs.getInt(Name.THEME, 1);
    }
    ...
    public int getProxyChoice() {
        @Constants.Proxy int proxy = mPrefs.getInt(Name.PROXY_CHOICE, Constants.PROXY_MPVG);
        switch (proxy) {
            case Constants.NO_PROXY:
            case Constants.PROXY_ORBOT:
            case Constants.PROXY_I2P:
            case Constants.PROXY_MANUAL:
            case Constants.PROXY_MPVG:
                return proxy;
            default:
                return Constants.PROXY_MPVG;
        }
    }

    public String getDefaultCountry() {
        return mPrefs.getString(Name.DEFAULT_COUNTRY,"");
    }

    public String getCountry() {
        return mPrefs.getString(Name.COUNTRY,getDefaultCountry());
    }

    public String getUserSetting() {
        return mPrefs.getString(Name.USERSETTING, "");
    }
    ...
    public String getPayMethod() {
        return mPrefs.getString(Name.PAY_METHOD, "");
    }
    ...
    public String getProxyServerData() {
        return mPrefs.getString(Name.PROXY_SERVER_DATA,"");
    }
    ...
    public void setMpvgProxyHost() {
        putString(Name.PROXY_HOST,MPVGProxyHost);
    }

    public void setMpvgProxyPort(int proxyPort) {
        putInt(Name.PROXY_PORT, proxyPort);
    }

    public void setInitialProxyPort(int initialProxyPort) {
        putInt(Name.INITIAL_PROXY_PORT, initialProxyPort);
    }

    public void setUserSetting(String userSetting) {
        putString(Name.USERSETTING, userSetting);
    }
    ...
    public void setProxyServerData(String serverData) {
        putString(Name.PROXY_SERVER_DATA, serverData);
    }

    public void setDefaultCountry(String countryName) {
        putString(Name.DEFAULT_COUNTRY, countryName);
    }

    public void setCountry(String countryName) {
        putString(Name.COUNTRY, countryName);
    }

    public void setPayMethod(String payMethod) {
        putString(Name.PAY_METHOD, payMethod);
    }
}
